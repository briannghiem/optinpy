...
__eps = __xp.finfo(__xp.float64).eps
__resolution = __xp.finfo(__xp.float64).resolution
...
params = {'fminunc':{'method':'newton','params':\
          ...
          'jacobian':{'algorithm':'central','epsilon':__xp.sqrt(__eps)},\
          'hessian':{'algorithm':'central','epsilon':__xp.sqrt(__eps),'initial':None},\
